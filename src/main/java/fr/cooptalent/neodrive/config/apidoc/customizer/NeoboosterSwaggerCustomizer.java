...
package fr.cooptalent.neodrive.config.apidoc.customizer;
 ...
 */
public class NeoboosterSwaggerCustomizer implements SwaggerCustomizer, Ordered {
    ...
    public NeoboosterSwaggerCustomizer(ApplicationProperties.Swagger properties) {
